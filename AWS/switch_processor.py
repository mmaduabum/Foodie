...
def update_subscriptions(conn,cursor):
    ...
    subs_check = "select user_id, switch_id, sub_timeout from map where sub_timeout != null;"
    ...
    for sub in subs:
        ...
        if now > end:
            update_map = 'update map set fetty_flag = 0, sub_timeout = null where switch_id == ' + switch_id +" and user_id == " + u_id  + ';'
